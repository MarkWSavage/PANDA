...
- **One test-energy-choice guidance finding** (2026-07-22): 200 MeV Au197, while useful for the ICRU73 mean-LET fix (v1.7.10/v1.7.11), sits at a specific energy (~1 MeV/nucleon) low enough that Geant4's own energy-loss straggling comes out anomalously narrow -- unrelated to the mean-LET fix. Confirmed by rerunning the same geometry at a realistic 3 GeV (~15 MeV/nucleon): the spectrum shape changes from a delta-function-like spike to a properly-spread peak. Heavy-ion test macros/results going forward should favor energies at or above ~1 GeV for Au-mass ions.
