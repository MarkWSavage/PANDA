...
class PandaGUI(QWidget):
    def __init__(self):
        ...
        self.default_carrier_lifetime = "0.10 ns"
        self.default_electric_field = "1000 kilovolt/cm"
    ...
    def initUI(self):
        ...
        self.collection_checkbox = QCheckBox("Use Charge Collection Model")
        ...
        control_layout.addWidget(self.analyze_button, 0, 1)
        ...
        self.plot_spec_button.clicked.connect(
            lambda: self.open_file("differential_charge_spectrum.png")
        )
        control_layout.addWidget(self.plot_spec_button, 1, 0)
        ...
        self.plot_sigma_button.clicked.connect(
            lambda: self.open_file("cumulative_cross_section.png")
        )
        control_layout.addWidget(self.plot_sigma_button, 1, 1)
        ...
        control_layout.addWidget(self.open_results_button, 3, 0, 1, 2)
